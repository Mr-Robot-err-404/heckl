...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/recent-prs", s.handleListRecentPRs)
	s.mux.HandleFunc("GET /api/recent-prs/filter", s.handleGetRecentPRFilter)
	s.mux.HandleFunc("PUT /api/recent-prs/filter", s.handleSetRecentPRFilter)
	...
	s.mux.HandleFunc("POST /api/notifications/read", s.handleReadNotifications)
